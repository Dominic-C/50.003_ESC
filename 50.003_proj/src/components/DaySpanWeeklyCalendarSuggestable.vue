...
export default {
  ...
  computed:
  {
    ...
    {
      if (this.suggesting){
        console.log(mouseEvent.calendarEvent);
				return !mouseEvent.calendarEvent.data.locked && this.$dayspan.features.drag && this.handleAdd && !this.readOnly && !this.$dayspan.readOnly;
			}
  ...
  methods:
  {
    ...
    {
      if (this.canMove(mouseEvent) && mouseEvent.left)
      {
